...
public class CourseUserController {
    ...
    public ResponseEntity<Object> getAllUsersByCourse(@PageableDefault(page = 0, size = 5, sort = "userId", direction = Sort.Direction.ASC)
                                                               Pageable pageable,
    ...
    @PostMapping("course/{courseId}/subscribe-user")
